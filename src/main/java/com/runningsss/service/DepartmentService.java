 ...
 * @date 2018-11-29
 */
@CacheConfig(cacheNames = "dept",cacheManager = "myCacheManager")/** 抽取缓存配置的公用信息*/
@Service
public class DepartmentService {
     ...
     * sync：是否使用异步模式
     */
    @Cacheable(cacheNames = "dept"/*, key = "#root.methodName+'['+#id+']'"*/,unless = "#result == null")
    public Department getDepartmentById(Integer id) {
        System.out.println("===查询部门" + id + "信息===");
